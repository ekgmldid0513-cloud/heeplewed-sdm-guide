...
const TAGS = {
  studio: {
    ...
    rooms: [
      ...
      "플라워가득", "소파씬", "통창", "계단씬", "분수대", "빔프로젝터", "한옥", "클래식&앤티크",
    ],
    product: [
  ...
  shootConcept: [
    ...
    "창문(자연광)", "테라스(루프탑)", "하늘씬", "한옥씬", "클래식&앤티크",
  ],
 
  dress: {
    material1: ["미카도 실크", "오간자실크", "도비실크" , "튤", "타프타", "새틴 실크", "리퀴드실크", "자카드실크", "플리츠"],
    material2: ["아플리케레이스", "블망레이스", "캐미컬레이스", "기타레이스"],
    material3: ["글리터,펄", "맑은 비즈", "화려한 비즈(스톤비즈or스와로브스키 등)"],
    topLine: ["일자탑", "하트탑", "피크드탑", "상체디테일탑", "오프숄더", "원숄더", "스퀘어넥", "하트스퀘어넥", "브이넥", "홀터넥", "하이넥", "라운드넥", "슬리브리스(민소매)", "반팔소매", "긴팔소매"],
    skirtLine: ["A라인", "벨라인", "머메이드라인", "세미라인", "미니멀스타일(발이 보이는 기장)"],
    etcKeyword: ["레이어드스커트", "캉캉스커트", "트임드레스", "투피스" , "미니드레스", "딥브이", "백포인트(등파임)", "수입드레스"],
